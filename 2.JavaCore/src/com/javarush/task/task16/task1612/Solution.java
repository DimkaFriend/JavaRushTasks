...
public class Solution {
    ...
    public static class Stopwatch extends Thread {
        ...
        private void doStep() throws InterruptedException {
            stepNumber++;
            Thread.sleep(1000 / owner.getSpeed());//Stopwatch.sleep(1000/owner.getSpeed());
            /*
            * В данной  задаче  необходимо  было использовать именно
             * родительский метод .sleep() класса Stopwatch, а не дочерний*/
